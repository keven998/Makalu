...
package com.aizou.peachtravel.common.thirdpart.weiboapi;

import android.util.SparseArray;

import com.aizou.peachtravel.common.thirdpart.AbsOpenAPI;
 ...
 * @since 2014-03-03
 */
public class WeiboUsersAPI extends AbsOpenAPI {
    ...
    public WeiboUsersAPI(Oauth2AccessToken accessToken) {
        super(accessToken);
    }
