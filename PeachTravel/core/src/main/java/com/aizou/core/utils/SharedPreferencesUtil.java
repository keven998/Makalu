...
public class SharedPreferencesUtil {
	...
	public static void saveValue(Context context, String key, String value) {
		saveValueTOFile(context, key, value, LibConfig.DEFAULT_SHAREDPREFERENCES_NAME);
	}
	/**
	 * 描述：保存字段到本地默认文件 默认保留到chinamworldbocsp文件下
	 * @param context  上下文对象
	...
	public static String getStringValue(Context context, String key,String defaultValue){
		return	getStringValueOfFile(context, key, defaultValue, LibConfig.DEFAULT_SHAREDPREFERENCES_NAME);
	}
	/**
	 * 描述：获取保存的字段值
	 * @param context
	...
	public static int getIntValue(Context context, String key,int defaultValue){
		return getIntValueOfFile(context, key, defaultValue, LibConfig.DEFAULT_SHAREDPREFERENCES_NAME);
	}
	/**
	 * 描述：获取保存的字段值
	 * @param context
	...
	public static boolean getBooleanValue(Context context, String key,boolean defaultValue){
		return getBooleanValueOfFile(context, key, defaultValue, LibConfig.DEFAULT_SHAREDPREFERENCES_NAME);
	}
