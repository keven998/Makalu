 ...
 * you must call {@link #setup(android.content.Context, android.support.v4.app.FragmentManager, int)} to complete the
...
public class FragmentTabHost extends TabHost implements
	 ...
	 *             {@link #setup(android.content.Context, android.support.v4.app.FragmentManager)} or
	 *             {@link #setup(android.content.Context, android.support.v4.app.FragmentManager, int)}.
	 */
	@Override
	@Deprecated
	public void setup() {
