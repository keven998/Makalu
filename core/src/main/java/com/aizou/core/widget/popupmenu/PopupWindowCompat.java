...
/**
 * Works around bugs in the handling of {@link android.view.ViewTreeObserver} by
 * {@link android.widget.PopupWindow}.
 * <p>
 * <code>PopupWindow</code> registers an {@link android.view.ViewTreeObserver.OnScrollChangedListener} with
 * {@link android.view.ViewTreeObserver}, but does not keep a reference to the observer
