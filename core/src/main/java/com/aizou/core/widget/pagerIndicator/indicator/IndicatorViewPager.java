...
public class IndicatorViewPager {
	...
	public IndicatorViewPager(Indicator indicator, FixedViewPager viewPager) {
		super();
	...
	private FixedViewPager.OnPageChangeListener onPageChangeListener = new FixedViewPager.OnPageChangeListener() {
