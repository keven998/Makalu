package com.aizou.core.widget.prv;
...
public class RotateLoadingLayout extends LoadingLayout {
	...
	private void init(Context context) {
		...
		mArrowImageView.setImageResource(R.drawable.ic_ptr_rotate);
		onLoadingDrawableSet(mArrowImageView.getDrawable());
	...
	protected View createLoadingView(Context context, AttributeSet attrs) {
		View container = LayoutInflater.from(context).inflate(
				R.layout.view_pull_to_refresh_header2, null);
		return container;
	}
	...
	public void onPull(float scale) {
		...
		// mArrowImageView.setRotat(angle);
//		float angle = Math.max(0f, Math.min(180f, scale * 360f - 180f));
