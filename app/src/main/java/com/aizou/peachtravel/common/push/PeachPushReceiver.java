package com.aizou.peachtravel.common.push;
...
/**
 * Created by Rjm on 2014/11/11.
 */
public class PeachPushReceiver extends BroadcastReceiver {
        ...
        switch (bundle.getInt(PushConsts.CMD_ACTION)) {
            ...
            case PushConsts.GET_MSG_DATA:
                ...
                if (payload != null) {
                    ...
                    LogUtil.d("GetuiSdkDemo", "Got Payload:" + data);
                }
                break;
