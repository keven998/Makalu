...
public class SystemConfig {
    ...
    public static final String DEBUG_BASE_URL="http://182.92.150.243:9000/taozi";//"http://api2.taozilvxing.cn/taozi";
  ...
  //  public static final String RELEASE_DEBUG_BASE_URL="http://api2.taozilvxing.cn/taozi";
    public static final String RELEASE_BASE_URL="http://api.taozilvxing.cn/taozi";
    public static String BASE_URL = "http://182.92.150.243:9000/taozi";//http://api2.taozilvxing.cn/taozi";
}
