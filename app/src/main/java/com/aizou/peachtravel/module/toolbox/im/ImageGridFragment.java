...
import com.aizou.peachtravel.common.utils.video.ImageResizer;
import com.aizou.peachtravel.common.utils.video.Utils;
import com.aizou.peachtravel.common.widget.RecyclingImageView;
import com.aizou.peachtravel.module.toolbox.im.domain.VideoEntity;
...
//				Toast.makeText(getActivity(), "暂不支持大于10M的视频！", Toast.LENGTH_SHORT).show();
                ToastUtil.getInstance(getActivity()).showToast("还不支持>10M的视频");
				return;
			}
