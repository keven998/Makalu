            ...
            if (itemData.isContact) {
                ...
                actionButton.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        intent.putExtra("sms_body", String.format("我正在用旅行派，汇聚全球特色旅游体验项目的应用。搜索：%s 加我,下载地址:http://www.lvxingpai.com/app/download/", AccountManager.getInstance().getLoginAccount(AddPhoneContactActivity.this).getNickName()));
                        startActivity(intent);
                    }
                });
            }
