...
/**
 * Created by xuyongchen on 15/9/9.
 ...
 * @author Alan
 */
public class RoundImageBoarderView extends ImageView{
    ...
    public RoundImageBoarderView(Context context) {
        super(context);
        mContext = context;
    }

    public RoundImageBoarderView(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
        setCustomAttributes(attrs);
    }

    public RoundImageBoarderView(Context context, AttributeSet attrs, int defStyle) {
