 ...
 * {@link com.xuejian.client.lxp.common.widget.dslv.SimpleDragSortCursorAdapter.ViewBinder#setViewValue(android.view.View, android.database.Cursor, int)}
 * is invoked. If the returned value is true, binding has occured. If the
 * returned value is false and the view to bind is a TextView,
 * {@link #setViewText(android.widget.TextView, String)} is invoked. If the returned value
...
public class SimpleDragSortCursorAdapter extends ResourceDragSortCursorAdapter {
    ...
    /**
     * Returns the {@link com.xuejian.client.lxp.common.widget.dslv.SimpleDragSortCursorAdapter.ViewBinder} used to bind data to views.
     *
