...
package com.xuejian.client.lxp.common.widget.twowayview.layout;
...
import com.xuejian.client.lxp.common.widget.twowayview.core.TwoWayLayoutManager;

import static com.xuejian.client.lxp.common.widget.twowayview.layout.Lanes.calculateLaneSize;
...
public abstract class BaseLayoutManager extends TwoWayLayoutManager {
    ...
    protected static class ItemEntry implements Parcelable {
        ...
        void setLane(com.xuejian.client.lxp.common.widget.twowayview.layout.Lanes.LaneInfo laneInfo) {
    ...
    protected final com.xuejian.client.lxp.common.widget.twowayview.layout.Lanes.LaneInfo mTempLaneInfo = new com.xuejian.client.lxp.common.widget.twowayview.layout.Lanes.LaneInfo();
    ...
    void getLaneForChild(com.xuejian.client.lxp.common.widget.twowayview.layout.Lanes.LaneInfo outInfo, View child, Direction direction) {
