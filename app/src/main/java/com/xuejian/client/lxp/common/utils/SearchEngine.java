...
public class SearchEngine {
    private static final String DB_FILE = "peach_pydb";
                ...
                synchronized (DB_FILE) {
                    if (hanzi2Pinyin == null || hanzi2Pinyin.size() <= 0) {
                        try {
                            ...
                            InputStream is = context.getResources().openRawResource(R.raw.peach_pydb);
                            ...
                            hanzi2Pinyin = GsonTools.parseJsonToBean(json, typeToken);
