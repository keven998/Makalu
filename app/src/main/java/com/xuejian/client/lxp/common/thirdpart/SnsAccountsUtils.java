...
public class SnsAccountsUtils {
	...
	public interface WeiboConstants {
		String APP_KEY		= "1487990731";
//		public static final String APP_SECRET 	= "f590ef1f8a1fd101a325d754b877ca10";
String REDIRECT_URL = "http://www.lvxingpai.com";
		String SCOPE = "follow_app_official_microblog,friendships_groups_read";
	}
	
	public interface TencentConstants {
		String APP_KEY		= "1102120105";
...
String SCOPE = "get_user_info,get_simple_userinfo";
    ...
    public interface WeiXinConstants {
        String APP_ID		= "wx86048e56adaf7486";      //wx26b58c7173483529
