...
public class TagParentFlowLayout extends ViewGroup {
    ...
    public TagParentFlowLayout(Context context) {
        super(context);
        this.readStyleParameters(context, null);
    }

    public TagParentFlowLayout(Context context, AttributeSet attributeSet) {
        super(context, attributeSet);
        this.readStyleParameters(context, attributeSet);
    }

    public TagParentFlowLayout(Context context, AttributeSet attributeSet, int defStyle) {
    ...
    private void readStyleParameters(Context context, AttributeSet attributeSet) {
        TypedArray a = context.obtainStyledAttributes(attributeSet,
                R.styleable.TagParentFlowLayout);
        try {
            horizontalSpacing = a.getDimensionPixelSize(
                    R.styleable.TagParentFlowLayout_horizontalSpace, 0);
            verticalSpacing = a.getDimensionPixelSize(
                    R.styleable.TagParentFlowLayout_verticalSpace, 0);
            orientation = a.getInteger(R.styleable.TagParentFlowLayout_orien,
                    HORIZONTAL);
            debugDraw = a.getBoolean(R.styleable.TagParentFlowLayout_debug_Draw, false);
        } finally {
            a.recycle();
        }
    }
    ...
    public static class LayoutParams extends ViewGroup.LayoutParams {
        ...
        private void readStyleParameters(Context context,
            ...
            TypedArray a = context.obtainStyledAttributes(attributeSet,
                    R.styleable.TagParentFlowLayout_LP);
            try {
                horizontalSpacing = a
                        .getDimensionPixelSize(
                                R.styleable.TagParentFlowLayout_LP_layout_horizontalSpace,
                                NO_SPACING);
                verticalSpacing = a
                        .getDimensionPixelSize(
                                R.styleable.TagParentFlowLayout_LP_layout_verticalSpace,
                                NO_SPACING);
                newLine = a.getBoolean(
                        R.styleable.TagParentFlowLayout_LP_layout_new_Line,
                        false);
            } finally {
                a.recycle();
            }
