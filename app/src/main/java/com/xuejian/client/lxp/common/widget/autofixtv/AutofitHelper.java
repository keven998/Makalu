package com.xuejian.client.lxp.common.widget.autofixtv;
...
/**
 * A helper class to enable automatically resizing {@link android.widget.TextView}`s {@code textSize} to fit
 * within its bounds.
 *
...
public class AutofitHelper {
    ...
    /**
     * Creates a new instance of {@code AutofitHelper} that wraps a {@link android.widget.TextView} and enables
    ...
    /**
     * Adds an {@link com.xuejian.client.lxp.common.widget.autofixtv.AutofitHelper.OnTextSizeChangeListener} to the list of those whose methods are called
     * whenever the {@link android.widget.TextView}'s {@code textSize} changes.
     */
    ...
    /**
     * Removes the specified {@link com.xuejian.client.lxp.common.widget.autofixtv.AutofitHelper.OnTextSizeChangeListener} from the list of those whose methods
     * are called whenever the {@link android.widget.TextView}'s {@code textSize} changes.
     */
    ...
    /**
     * @see android.widget.TextView#getMaxLines()
     */
