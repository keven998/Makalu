 ...
 */
package com.xuejian.client.lxp.common.hxsdk.controller;
...
import com.xuejian.client.lxp.common.hxsdk.model.HXSDKModel;
 ...
 * 不过继承类需要根据要求求提供相应的函数，尤其是提供一个{@link com.xuejian.client.lxp.common.hxsdk.model.HXSDKModel}. 所以请实现abstract protected HXSDKModel createModel();
...
public abstract class HXSDKHelper {
    ...
    /**
     * the subclass must override this class to provide its own model or directly use {@link com.xuejian.client.lxp.common.hxsdk.model.DefaultHXSDKModel}
     * @return
     */
