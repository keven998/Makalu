 ...
 * to {@link com.xuejian.client.lxp.common.widget.dslv.DragSortListView#setAdapter(ListAdapter)} and, since
 * this class implements the {@link com.xuejian.client.lxp.common.widget.dslv.DragSortListView.DragSortListener}
...
public abstract class DragSortCursorAdapter extends CursorAdapter implements DragSortListView.DragSortListener {
     ...
     *
     * @see com.xuejian.client.lxp.common.widget.dslv.DragSortListView.DropListener#drop(int, int)
     */
    @Override
     ...
     * the current mapping with {@link getCursorPositions()}.
     *
     * @see com.xuejian.client.lxp.common.widget.dslv.DragSortListView.RemoveListener#remove(int)
     */
    @Override
